...
const checks = {
  ...
  "existing STT endpoint retained": backend.includes('@app.post("/api/stt/transcribe")'),
...
console.log(`PASS STT-WORKTREE-RECOVERY: ${Object.keys(checks).length}/${Object.keys(checks).length} proven STT baseline gates green.`);
